        ...
        <div id="step-2" class="step-content hidden">
          ...
          <div class="space-y-4">
            <div
              ...
              <label class="w-full md:w-1/3 font-medium text-gray-700">Nama Lengkap*</label>
            ...
            <div
              class="flex flex-col md:flex-row items-start md:items-center space-y-1 md:space-y-0 space-x-0 md:space-x-4">
              <label class="w-full md:w-1/3 font-medium text-gray-700">Provinsi*</label>
              <div class="full-input-container">
                <input
                  name="provinsi"
                  type="text"
            ...
            <div
              class="flex flex-col md:flex-row items-start md:items-center space-y-1 md:space-y-0 space-x-0 md:space-x-4">
              <label class="w-full md:w-1/3 font-medium text-gray-700">Kabupaten/Kota*</label>
              <div class="full-input-container">
                <input
                  name="kabupaten"
                  type="text"
            ...
            <div
              ...
              <label class="w-full md:w-1/3 font-medium text-gray-700 pt-3">Alamat*</label>
              <div class="full-input-container">
                <textarea
                  name="alamat"
                  id="address"
                  ...
                  oninput="clearErrorStyle('address'); checkStepButton(2)"></textarea>
                <p
                  id="error-address"
                  class="text-sm text-red-500 mt-1 hidden">
                  Pesan Error
            ...
            <div
              class="flex flex-col md:flex-row items-start md:items-center space-y-1 md:space-y-0 space-x-0 md:space-x-4">
              <label class="w-full md:w-1/3 font-medium text-gray-700">No. Telp*</label>
              <div class="full-input-container">
                <input
                  name="no_telp"
                  type="tel"
        ...
        <div id="step-3" class="step-content hidden">
          ...
          <div class="space-y-4 max-w-md mx-auto">
            <div class="flex items-center mb-6">
              ...
              <span
                id="display-username"
                class="text-xl font-bold text-[#a76657]"></span>
            </div>

            <div class="flex items-center">
              <label class="w-1/3 font-medium text-gray-700">Nama Lengkap</label>
              <input
                type="text"
                id="display-fullName"
                readonly
            ...
            <div class="flex items-start">
              ...
              <textarea
                id="display-address"
                readonly
                class="block w-2/3 h-auto resize-none border-0 border-b-2 border-gray-400 bg-transparent py-1.5 px-0 text-gray-900 sm:text-base cursor-default"></textarea>
            </div>
          </div>
